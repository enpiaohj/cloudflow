...
- **版本**：Semantic Versioning，当前 `0.6.0`（Tag `v0.6.0`；已发布 `v0.1.0`、`v0.2.0`、`v0.3.0`、`v0.4.0`、`v0.4.1`、`v0.5.0`、`v0.5.1`、`v0.6.0`——`v0.5.2`~`v0.5.9` 是同一次测试迭代过程中的本地未推送版本，合并进 `v0.6.0` 后未发布，不再单独存在）
